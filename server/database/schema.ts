...
export const userSettings = pgTable("user_settings", {
  ...
  // Complex index: CREATE UNIQUE INDEX idx_user_settings_user_id ON user_settings USING btree (((user_id).user_id)),
]);
...
export const userFavorites = pgTable("user_favorites", {
  ...
  // Complex index: CREATE UNIQUE INDEX idx_user_fav_user_paper ON user_favorites USING btree (((user_id).user_id), paper_id),
]);
...
export const papers = pgTable("papers", {
  ...
  fetchedAt: customTimestamptz("fetched_at", { precision: 3 }),
  // System field: Creation time (auto-filled, do not modify)
  createdAt: customTimestamptz("_created_at", { precision: 3 }).notNull().default(sql`CURRENT_TIMESTAMP`),
  // System field: Creator (auto-filled, do not modify)
  createdBy: userProfile("_created_by").default(sql`CASE
